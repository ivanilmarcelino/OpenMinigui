...
FUNCTION _DefineProgressBar( ControlName, ParentFormName, x, y, w, h, lo, hi, ;
      tooltip, vertical, smooth, HelpId, invisible, value, BackColor, ;
      BarColor, marquee, velocity, nId, bInit )
*-----------------------------------------------------------------------------*
   ...
   *--------------------------------------------------------------------------*
   ...
   IF _HMG_BeginDialogActive
      ...
      IF lDialogInMemory
         ...
         blInit := {| a, b, c | InitDialogProgressBar( a, b, c ) }
   ...
   *--------------------------------------------------------------------------*
   ...
   IF !lDialogInMemory
      ...
      IF _HMG_IsThemed .AND. ;
         ( IsArrayRGB( BarColor ) .OR. ;
           IsArrayRGB( BackColor ) )

         IF IsArrayRGB( BarColor ) .AND. ;
            !IsArrayRGB( BackColor )
