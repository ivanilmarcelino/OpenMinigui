	...
	DEFINE WINDOW Form_1 ;
		...
		DEFINE MAIN MENU 
			...
			DEFINE POPUP 'M&isc'
				...
				SEPARATOR
				ITEM 'Set Grid Caption Property'	ACTION Form_1.Grid_1.Caption(1) := 'New Caption'
				ITEM 'Get Grid Caption Property'	ACTION MsgInfo ( ( Form_1.Grid_1.Caption(1) ) ,'Grid_1')
				SEPARATOR
...
*-----------------------------------------------------------------------------*
	 ...
	 Form_1.Label_1.Value 	:= "New Label Value" 
