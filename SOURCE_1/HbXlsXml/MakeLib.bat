...
:BUILD
  ...
  %MV_HRB%\bin\harbour xlsxml.prg -n -w3 -es2 -gc0 -i%MV_HRB%\include;%MG_ROOT%\include
  %MV_HRB%\bin\harbour xlsxml_s.prg xlsxml_y.prg -n -w3 -es2 -gc0 -i%MV_HRB%\include;%MG_ROOT%\include
