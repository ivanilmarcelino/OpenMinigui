...
Local aRows
   ...
   DEFINE WINDOW Form_1 ;
      ...
      @ 50,10 GRID Grid_1 ;
         ...
         VALUE 1;
         CELLNAVIGATION;
         ON CHECKBOXCLICKED {|sp,CellRowClicked|MsgInfo ({"Row: ", hb_ntos(CellRowClicked), " is checked: ", Form_1.Grid_1.CheckBoxItem( CellRowClicked )}, "On CheckBoxClicked")}

      Form_1.Grid_1.CheckBoxEnabled := .T.

      @ 450, 155 BUTTON Button_1 CAPTION "CheckBoxEnabled ON/OFF" WIDTH 150 ACTION Form_1.Grid_1.CheckBoxEnabled := .NOT. Form_1.Grid_1.CheckBoxEnabled
   ...
   IF Form_1.Grid_1.CheckBoxEnabled == .T.
      FOR i = 1 TO Form_1.Grid_1.ItemCount
         IF Form_1.Grid_1.CheckBoxItem ( i ) == .T.
            cList := cList + Form_1.Grid_1.Cell (i, 1) +", "+ Form_1.Grid_1.Cell (i, 2) + hb_OsNewLine()
         ENDIF
      NEXT
      IF EMPTY (cList)
         cList := "Empty List"
