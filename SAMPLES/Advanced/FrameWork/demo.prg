 ...
 * Copyright 2006-2021 Grigory Filatov <gfilatov@inbox.ru>
 */
...
*--------------------------------------------------------*
   ...
   IF lShow
      ...
      DEFINE TOOLBAREX ToolBar_1 OF Form_1 BUTTONSIZE 34, 34 IMAGELIST 'ImageList_1' FLAT
...
*--------------------------------------------------------*
   ...
   IF lShow
      ...
      IF Empty( _HMG_ActiveFormName )
         _HMG_ActiveFormName := ThisWindow.Name
      ENDIF

      _HMG_BeginWindowActive := .T.

      DEFINE STATUSBAR OF &_HMG_ActiveFormName KEYBOARD FONT 'MS Sans Serif' SIZE 8

      END STATUSBAR

      This.StatusBar.Item( 1 ) := "Ready"
      _HMG_DefaultStatusBarMessage := This.StatusBar.Item( 1 )
