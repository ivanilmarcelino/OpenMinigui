...
///////////////////////////////////////////////////////////////////////////////////////////////////////
FUNCTION DynamicContextMenuExtend( cForm, aDim, nPos, nBmpSize, nFSize, lExit, aFont, cType, aHFont )
   LOCAL Font1, Font2, nY, nX, nI, lMenuStyle, nMenuBitmap, hFont, nH, nW, nS := nBmpSize
   LOCAL nChoice, aMenu, cMenu, bAction, cName, cImg, lChk, lDis, lIcon, cExit
   LOCAL hForm := GetFormHandle( cForm )
   DEFAULT aFont := {} , cType := "BMP", aHFont := {}
   ...
   IF LEN(aFont) > 0
      DEFINE FONT Font_1dcm  FONTNAME aFont[1] SIZE nFSize
      DEFINE FONT Font_2dcm  FONTNAME aFont[2] SIZE nFSize BOLD
   ELSE
   ...
   DEFINE CONTEXT MENU OF &cForm
      ...
      IF !Empty(lExit)
         nH += 4
         SEPARATOR
         MENUITEM  cExit  ACTION {|| nChoice := 0 } FONT Font1 ICON "iReturn48x1"
         nH += nS + 4
      ENDIF
