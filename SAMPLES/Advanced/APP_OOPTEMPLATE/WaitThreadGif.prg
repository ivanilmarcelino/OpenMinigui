 ...
 * ВНИМАНИЕ ! В больших программах у Gif-объекта может пропасть анимация
 * ATTENTION ! In large programs, the Gif object may lose animation
 *
 * Copyright 2015-23 Verchenko Andrey <verchenkoag@gmail.com>
