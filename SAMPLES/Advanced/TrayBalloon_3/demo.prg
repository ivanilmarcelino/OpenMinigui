 ...
 *
 * Copyright 2015-2019 Grigory Filatov <gfilatov@inbox.ru>
*/
...
*--------------------------------------------------------*
   ...
   Local nIconIndex, nRow := 104

   FOR nIconIndex := 1 TO 3
      DrawIconEx( hMainWin, 20, nRow, ahTrayIcons[ nIconIndex ], 16, 16, GetSysColor( COLOR_BTNFACE ), .F. )
      nRow += 38
   NEXT
