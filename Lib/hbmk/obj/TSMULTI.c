 ...
 * Generated C source from "TSMULTI.PRG"
 */
...
HB_FUNC_STATIC( TSMULTI_NEW );
HB_FUNC_STATIC( TSMULTI_DEFAULT );
HB_FUNC_STATIC( TSMULTI_HANDLEEVENT );
HB_FUNC_STATIC( TSMULTI_GETDLGCODE );
HB_FUNC_STATIC( TSMULTI_KEYCHAR );
HB_FUNC_STATIC( TSMULTI_KEYDOWN );
HB_FUNC_STATIC( TSMULTI_LOSTFOCUS );
HB_FUNC_STATIC( TSMULTI_LVALID );
HB_FUNC_STATIC( TSMULTI_COMMAND );
HB_FUNC_STATIC( TSMULTI_SAVE );
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_TSMULTI )
{ "TSMULTI", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( TSMULTI )}, NULL },
...
{ "TSMULTI_NEW", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TSMULTI_NEW )}, NULL },
{ "TSMULTI_DEFAULT", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TSMULTI_DEFAULT )}, NULL },
{ "TSMULTI_HANDLEEVENT", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TSMULTI_HANDLEEVENT )}, NULL },
{ "TSMULTI_GETDLGCODE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TSMULTI_GETDLGCODE )}, NULL },
{ "TSMULTI_KEYCHAR", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TSMULTI_KEYCHAR )}, NULL },
{ "TSMULTI_KEYDOWN", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TSMULTI_KEYDOWN )}, NULL },
{ "TSMULTI_LOSTFOCUS", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TSMULTI_LOSTFOCUS )}, NULL },
{ "TSMULTI_LVALID", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TSMULTI_LVALID )}, NULL },
{ "TSMULTI_COMMAND", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TSMULTI_COMMAND )}, NULL },
{ "TSMULTI_SAVE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TSMULTI_SAVE )}, NULL },
...
{ "LEDITBOX", {HB_FS_PUBLIC | HB_FS_MESSAGE}, {NULL}, NULL },
{ "OCOL", {HB_FS_PUBLIC | HB_FS_MESSAGE}, {NULL}, NULL },
{ "CEDITBOXSEP", {HB_FS_PUBLIC | HB_FS_MESSAGE}, {NULL}, NULL },
{ "STRTRAN", {HB_FS_PUBLIC}, {HB_FUNCNAME( STRTRAN )}, NULL },
{ "NEDITBOXWRAP", {HB_FS_PUBLIC | HB_FS_MESSAGE}, {NULL}, NULL },
{ "BEDITEND", {HB_FS_PUBLIC | HB_FS_MESSAGE}, {NULL}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_TSMULTI, "TSMULTI.PRG", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_TSMULTI
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_TSMULTI )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( TSMULTI )
{
   ...
   do {
	...
	hb_xvmPushStringConst( "TSMulti", 7 );
