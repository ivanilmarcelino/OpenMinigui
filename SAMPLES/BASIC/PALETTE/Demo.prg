...
FUNCTION toolWin()
   ...
   If IsWindowActive ( Form_Fl )
      ...
      DEFINE WINDOW Form_Fl ;
         ...
         DEFINE TOOLBAREX ToolBar_i OF Form_fl BUTTONSIZE 16,16  FLAT TOOLBARSIZE 100
            ...
            BUTTON Button_4 ;
               ...
               ACTION MsgInfo('Click 4! ') NOTRANSPARENT
...
FUNCTION toolWin2()
   ...
   If IsWindowActive ( Form_Fl )
      ...
      DEFINE WINDOW Form_Fl ;
         ...
         DEFINE TOOLBAREX ToolBar_i BUTTONSIZE 24,24 IMAGELIST IDB_STD_LARGE_COLOR  CAPTION 'Large Buttons from DLL' FLAT BREAK
