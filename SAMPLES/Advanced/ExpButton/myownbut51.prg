...
*-----------------------------------------------------------------------------*
   ...
   ELSEIF ! ( _HMG_aControlRangeMax[ i ][ 1 ] == 1 )      // normal
      ...
      IF aButStyles[ iButStyle, 9 ] = 1
         rectdraw( hWnd, aBtnRc[ 1 ] -1, aBtnRc[ 2 ] -1, aBtnRc[ 4 ] + 1, aBtnRc[ 3 ] + 1, aButStyles[ iButStyle, 10 ], 1, WHITE, .F. )
      ELSEIF aButStyles[ iButStyle, 9 ] = 2
         roundrectdraw( hWnd, aBtnRc[ 1 ] -1, aBtnRc[ 2 ] -1, aBtnRc[ 4 ] + 1, aBtnRc[ 3 ] + 1, 8, 8, aButStyles[ iButStyle, 10 ], 1, WHITE, .F. )
      ENDIF
   ...
   ELSE                                // over
      ...
      IF aButStyles[ iButStyle, 9 ] = 1
         rectdraw( hWnd, aBtnRc[ 1 ] -1, aBtnRc[ 2 ] -1, aBtnRc[ 4 ] + 1, aBtnRc[ 3 ] + 1, aButStyles[ iButStyle, 11 ], 1, WHITE, .F. )
      ELSEIF aButStyles[ iButStyle, 9 ] = 2
         roundrectdraw( hWnd, aBtnRc[ 1 ] -1, aBtnRc[ 2 ] -1, aBtnRc[ 4 ] + 1, aBtnRc[ 3 ] + 1, 8, 8, aButStyles[ iButStyle, 11 ], 1, WHITE, .F. )
      ENDIF
   ...
   ELSE
      ...
      IF ! lDisabled
         ...
         IF lSelected
            ...
            ELSE
               DrawGlyph( hDC, aBtnRc[ 1 ], aBtnRc[ 2 ], aBtnRc[ 3 ], aBtnRc[ 4 ], _HMG_aControlBrushHandle[ i ], rgbTrans, .F., .T. )
