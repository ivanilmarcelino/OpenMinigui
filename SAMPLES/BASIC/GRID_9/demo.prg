...
PROCEDURE Main
   ...
   DEFINE POPUP 'Actions'
      ...
      MENUITEM 'Insert Row' ACTION InsertRow( aRows )
   ...
   ENDIF
   Form_1.Width := Form_1.Grid_1.Width + 2 * GetBorderWidth() + 2 * Form_1.Grid_1.Col
...
PROCEDURE InsertRow( aArr )
   ...
   AIns( aArr, Form_1.Grid_1.Value [1], { '', 'Reyes', 'Monica', 1, 1, 1 }, .T. )
   Form_1.Grid_1.ItemCount := Len( aArr )
