 ...
 * Dois Irmãos - RS
 *
 * Revized: Grigory Filatov <gfilatov@gmail.com>
 * Date: 01/30/2007
 * Lib HMG 1.3 Extended Build 31
 *
 * Fixed: Grigory Filatov <gfilatov@gmail.com>
 * Date: 05/11/2007
...
Procedure Main()
  ...
  Private cIni := GetStartupFolder()+"\demo.ini"
...
Function Salvar_dados()
  ...
  BEGIN INI FILE ( cIni )
     ...
     SET SECTION "E-Mail"        ENTRY "Senha"      To Crypt(_senha,"E" )
  END INI
Return Nil
/*
*/
