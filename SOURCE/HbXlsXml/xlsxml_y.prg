...
METHOD ExcelWriterXML_Style:getStyleXML()
   ...
   IF ::useAlignment
      xml += "      <Alignment " + AllTrim( valign + " " + halign + " " + rotate + " " + shrinktofit + " " + wraptext + " " + verticaltext + " " + indent ) + "/>" + hb_eol()
   ENDIF
   IF ::useBorder
      xml += borders
   ENDIF
...
METHOD ExcelWriterXML_Style:setIndent( indent )
