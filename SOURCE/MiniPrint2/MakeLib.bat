...
:BUILD
  ...
  %MG_BCC%\bin\bcc32 -c -O2 -tWM -d -6 -OS -I%MV_HRB%\include;%MG_BCC%\include;%MG_ROOT%\include -L%MV_HRB%\lib;%MG_BCC%\lib -D_ERRORMSG_ miniprint.c localize.c
  %MG_BCC%\bin\tlib %MV_BUILD%\miniprint2.lib +miniprint.obj +localize.obj
