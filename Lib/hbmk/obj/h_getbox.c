...
lab00013: ;
	...
	hb_xvmPushSymbol( symbols + 327 );
	hb_xvmPushSelf();
	hb_xvmPushFuncSymbol( symbols + 329 );
	hb_xvmPushSymbol( symbols + 299 );
	hb_xvmPushSelf();
	if( hb_xvmSend( 0 ) ) break;
	if( hb_xvmFunction( 1 ) ) break;
...
lab00015: ;
	...
	if( ! fValue )
		goto lab00021;
	hb_xvmSetLine( 1610 );
	hb_xvmPushFuncSymbol( symbols + 331 );
	hb_xvmPushSymbol( symbols + 252 );
	hb_xvmPushSelf();
	if( hb_xvmSend( 0 ) ) break;
	if( hb_xvmFunction( 1 ) ) break;
...
HB_FUNC_STATIC( HMG_GET_SETKEYEVENT )
{
   ...
   do {
	hb_xvmFrame( 2, 5 );
	hb_xvmSetLine( 1666 );
	hb_xvmPushFuncSymbol( symbols + 334 );
